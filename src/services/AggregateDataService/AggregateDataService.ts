import {PreformatDataInterface, VariantReportType} from "../PreprocessingService/PreprocessingService";
import {
...
class AggregateDataService {
    public aggregateData(groups: PreformatDataInterface): AggregatedReportsInterface[] {
            ...
            return {
                ...
                duplicatesReports:
                    group.type === VariantReportType.DUPLICATES
                        ...
                        : [],
                commonReports: group.type === VariantReportType.COMMON ?
                    groupReportsByLanguage(group.data as FormattedParsedByProblemsFileInterface[]) : []
            }
        });
    }
}

function groupReportsByLanguage(reports: FormattedParsedByProblemsFileInterface[]) {
    const groupedObject = reports.reduce<{ [key: string]: FormattedParsedByProblemsFileInterface[] }>((acc, current) => {
