...
export const formatParsedByProblemsData = (item: ParsedProblemFileInterface) => ({
    file: item.file,
...
export const formatParsedDataByDuplicatedParams =
    (items: DataByDuplicatesParamsInterface[] = []): FormattedDataByDuplicatesParamsInterface[][] => {
...
export const formatParsedDataByProblemsParams =
    (items: ParsedProblemFileInterface[] | ParsedProblemFileInterface = []): FormattedParsedByProblemsFileInterface[] => {
